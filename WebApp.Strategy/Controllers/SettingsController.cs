...
namespace WebApp.Strategy.Controllers
{
    ...
    public class SettingsController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                settings.DatabaseType = (EDatabaseType)int.Parse(User.Claims.Where(x => x.Type == Settings.claimDatabaseType).FirstOrDefault().Value);
            }
            else
            {
        ...
        public async Task<IActionResult> ChangeDatabase(int databaseType)
        {
            ...
            var hasDatabaseTypeClaim = claims.Where(x => x.Type == Settings.claimDatabaseType).FirstOrDefault();
